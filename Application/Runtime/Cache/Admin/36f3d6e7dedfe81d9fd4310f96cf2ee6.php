...
<div class="myalert-main">
    <form class="mform">
        <div class="form-line w100 fl">
            <span class="form-label">IP段：</span>
            <div class="form-content" style="width: 500px;">
                <input class="form-control" type="text" name="ipseg" value="<?php echo ($ipseg); ?>" readonly>
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">IP地址：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="sipaddr" placeholder="输入起始IP地址">
            </div>
            <div class="form-content" style="width: 20px;margin-left: 13px;">一</div>
        </div>
        <div class="form-line w50 fl">
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="eipaddr" placeholder="输入结束IP地址">
            </div>
        </div>
    </form>  
</div>
