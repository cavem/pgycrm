...
<div class="myalert-main">
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <form class="mform">
                <input type="hidden" name="id" value="<?php echo ($finaninfo["id"]); ?>">
                <input type="hidden" name="fee_end_at" value="<?php echo ($finaninfo["fee_end_at"]); ?>">
                <input type="hidden" name="managersureby" value="<?php echo ($_SESSION['loginuser']['realname']); ?>">
                <td class="claaa"><b>主管确认</b></td>
                <td><b><?php echo ($_SESSION['loginuser']['realname']); ?></b></td>
                <td class="claaa"><b>主管确认时间</b></td>
                <input type="hidden" name="managersure_at" value="<?php echo date('Y-m-d H:i:s'); ?>">
