...
<div id="content" class="wow fadeIn">
    <div id="content-header">
        <span class="header-title"><i class="fa fa-windows"></i> 操作系统</span>
    ...
    <div class="container-fluid">
        <div class="someopt mt15">
            ...
            <if condition="$perm['资源管理']['操作系统']['新增']">
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                <th>编号</th><th>名称</th><th>系统类型</th><th>操作</th>
                </tr>
            </thead>
            <tbody>
                <?php if(is_array($oslist)): $k = 0; $__LIST__ = $oslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($vo["id"]); ?></td>
                        <td><?php echo ($vo["name"]); ?></td>
                        <td><?php echo ($vo["type"]); ?></td>
                        <td style="width: 200px;">
                            <?php if($perm['资源管理']['操作系统']['查看']): ?><button class="btn btn-sm btn-info view"><i class="fa fa-eye"></i></button><?php endif; ?>
                            <?php if($perm['资源管理']['操作系统']['修改']): ?><button class="btn btn-sm btn-warning edit"><i class="fa fa-edit"></i></button><?php endif; ?>
                            <?php if($perm['资源管理']['操作系统']['删除']): ?><button class="btn btn-sm btn-danger remove"><i class="fa fa-trash"></i></button><?php endif; ?>
                        </td>
