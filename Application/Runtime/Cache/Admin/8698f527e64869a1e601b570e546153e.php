...
<div id="content" class="wow fadeIn">
    <div id="content-header">
        <span class="header-title"><i class="fa fa-level-up"></i> 账户等级</span>
    ...
    <div class="container-fluid">
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                <th>编号</th><th>等级 </th><th>奖金</th><th>操作</th>
                </tr>
            </thead>
            <tbody>
                <?php if(is_array($levellist)): $k = 0; $__LIST__ = $levellist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
