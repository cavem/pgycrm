    ...
    <form class="mform">
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="company" value="<?php echo ($list["company"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">所属运营商：</span>
            <div class="form-content" style="width: 250px;">
                <select class="form-control" name="isp">
                    <option <?php if($list["isp"] == '蒲公英'): ?>selected<?php endif; ?>>蒲公英</option>
                    <option <?php if($list["isp"] == '宿迁电信'): ?>selected<?php endif; ?>>宿迁电信</option>
                    <option <?php if($list["isp"] == '广元'): ?>selected<?php endif; ?>>广元</option>
                    <option <?php if($list["isp"] == '美国'): ?>selected<?php endif; ?>>美国</option>
                    <option <?php if($list["isp"] == '苹果数据'): ?>selected<?php endif; ?>>苹果数据</option>
                </select>
            </div>
        </div>
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <select class="form-control" name="room">
                    ...
                    <?php if(is_array($roomlist)): $i = 0; $__LIST__ = $roomlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo == $list['room']): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">IP段地址：</span>
            <div class="form-content" style="width: 250px;">
                <input type="hidden" name="ipseg">
                <input class="form-control" type="text" name="seg1" value="<?php echo ($list["seg1"]); ?>" style="width: 56px;display: inline-block;">.
                <input class="form-control" type="text" name="seg2" value="<?php echo ($list["seg2"]); ?>" style="width: 56px;display: inline-block;">.
                <input class="form-control" type="text" name="seg3" value="<?php echo ($list["seg3"]); ?>" style="width: 56px;display: inline-block;">.
                <input class="form-control" type="text" name="seg4" value="<?php echo ($list["seg4"]); ?>" style="width: 56px;display: inline-block;">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">子网掩码：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="netmask" value="<?php echo ($list["netmask"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">所属VLAN：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="vlan" value="<?php echo ($list["vlan"]); ?>">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">所属路由器：</span>
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="router" value="<?php echo ($list["router"]); ?>">
            </div>
        </div>
    </form>  
</div>
