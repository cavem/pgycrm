    ...
    <form class="mform">
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="company" value="宿迁蒲公英网络有限公司">
            </div>
        </div>
        <div class="form-line w50 fl">
        ...
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="switch_id">
            </div>
        </div>
        <div class="form-line w50 fl">
        ...
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                共<input class="form-control" type="text" name="port_num" style="width: 200px;">口
            </div>
        </div>
        <div class="form-line fl">
            ...
            <div class="form-content" style="width: 663px;">
                <input class="form-control" type="text" name="ip_addr">
            </div>
        ...
        <div class="form-line w50 fl">
            ...
            <div class="form-content" style="width: 250px;">
                <input class="form-control" type="text" name="up_switch">
            </div>
        </div>
        <div class="form-line w50 fl">
            <span class="form-label">上联端口：</span>
            <div class="form-content" style="width: 250px;">
                第<input class="form-control" type="text" name="up_port" style="width: 200px;">口
            </div>
        </div>
    </form>  
</div>
