                ...
                <div class="layui-tab-item layui-show">
                    <form class="mform">
                        ...
                        <div class="form-line w50 fl">
                            ...
                            <span style="position: relative;left: 300px;bottom: 12px;color:#666;">注：留空不做修改</span>
                        </div>
                        <div class="form-line w50 fl">
                        ...
                        <div class="form-line w50 fl">
                            ...
                            <span style="position: relative;left: 300px;bottom: 12px;color:#666;">注：按住ctrl多选</span>
                        </div>
                        <div class="form-line w50 fl">
                            <span class="form-label">是否主管：</span>
                            <div class="form-content" style="width: 250px;">
                                是 <input type="radio" name="ischarge" value="true" <?php if($info["ischarge"] == 'true'): ?>checked<?php endif; ?>> 
                                否 <input type="radio" name="ischarge" value="false" <?php if($info["ischarge"] == 'false'): ?>checked<?php endif; ?>>
                            </div>
                        </div>
                        <div class="form-line fl">
                            <span class="form-label">是否销售人员：</span>
                            <div class="form-content" style="width: 250px;">
                                是 <input type="radio" name="issales" value="true" <?php if($info["issales"] == 'true'): ?>checked<?php endif; ?>> 
                                否 <input type="radio" name="issales" value="false"  <?php if($info["issales"] == 'false'): ?>checked<?php endif; ?>>
                            </div>
                        </div>
                        <div class="form-line w50 fl">
                            ...
                            <div class="form-content" style="width: 250px;">
                                ...
                                <input name="recvs" type="hidden" value="<?php echo $recvstr; ?>">
                            </div>
                        </div>
                        <div class="form-line w50 fl">
                        ...
                        <div class="form-line w50 fl">
                            ...
                            <div class="form-content" style="width: 250px;">
                                是 <input type="radio" name="isleave" value="true" <?php if($info["isleave"] == 'true'): ?>checked<?php endif; ?>> 
                                否 <input type="radio" name="isleave" value="false" <?php if($info["isleave"] == 'false'): ?>checked<?php endif; ?>>
                            </div>
                        </div>
                        <div class="form-line w50 fl">
                            <span class="form-label">角色权限：</span>
                            <div class="form-content" style="width: 250px;">
                                <select name="perm" class="form-control permsel">
                                    <option value="">【无权限】</option>
                                    <?php if(is_array($roleslist)): $i = 0; $__LIST__ = $roleslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["perm"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                    </form>
