...
$(function(){
    $('.add').click(function(){
        ...
        myalert('添加处理方式','900px','660px',"<?php echo U('Process/new');?>",confirm);
    })
    $('.edit').click(function(){
        ...
        myalert('修改处理方式','900px','660px',"<?php echo U('Process/edit');?>"+"?id="+id,confirm);
    })
    ...
    $('.gopage').click(function(){
        var cpage=$('.cpage').val();
        window.location.href="<?php echo U('Process/list');?>"+"?p="+cpage;
    })
})
</script>
<div id="content" class="wow fadeIn">
    <div id="content-header">
        ...
        <div class="mysearchbox fr">
            ...
            <form class="sform" action="<?php echo U('Process/list');?>" method="POST">
    ...
    <div class="container-fluid">
        <div class="someopt mt15">
            ...
            <?php if($perm['系统管理']['处理方式']['新增']): ?><button class="btn btn-primary fl add mr10"><i class="fa fa-plus"></i> 新增</button><?php endif; ?>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td><?php echo ($vo["goodlimit"]); ?></td>
                        <td><?php echo ($vo["goodbonus"]); ?></td>
                        <td><?php echo ($vo["coeff"]); ?></td>
                        <td><?php echo ($vo["dept"]); ?></td>
                        <td style="width: 200px;">
                            <?php if($perm['系统管理']['处理方式']['查看']): ?><button class="btn btn-sm btn-info view"><i class="fa fa-eye"></i></button><?php endif; ?>
                            <?php if($perm['系统管理']['处理方式']['修改']): ?><button class="btn btn-sm btn-warning edit"><i class="fa fa-edit"></i></button><?php endif; ?>
                            <?php if($perm['系统管理']['处理方式']['删除']): ?><button class="btn btn-sm btn-danger remove"><i class="fa fa-trash"></i></button><?php endif; ?>
                        </td>
