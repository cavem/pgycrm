...
$(function(){
    $('.add').click(function(){
        ...
        myalert('新增产品','900px','300px',"<?php echo U('Prokind/new');?>",confirm);
    })
    ...
    $('.gopage').click(function(){
        var cpage=$('.cpage').val();
        window.location.href="<?php echo U('Prokind/list');?>"+"?p="+cpage;
    })
})
</script>
<div id="content" class="wow fadeIn">
    <div id="content-header">
        ...
        <div class="mysearchbox fr">
            ...
            <form class="sform" action="<?php echo U('Prokind/list');?>" method="POST">
    ...
    <div class="container-fluid">
        <div class="someopt mt15">
            ...
            <?php if($perm['资源管理']['产品分类']['新增']): ?><button class="btn btn-primary fl add mr10"><i class="fa fa-plus"></i> 新增</button><?php endif; ?>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php if(is_array($prokindlist)): $k = 0; $__LIST__ = $prokindlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($vo["id"]); ?></td>
                        <td class="name"><?php echo ($vo["name"]); ?></td>
                        <td style="width: 200px;">
                            <?php if($perm['资源管理']['产品分类']['删除']): ?><button class="btn btn-danger btn-sm remove"><i class="fa fa-trash"></i></button><?php endif; ?>
                        </td>
