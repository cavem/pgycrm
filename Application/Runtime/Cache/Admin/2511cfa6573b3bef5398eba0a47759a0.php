...
$(function(){
    ...
    $('.edit').click(function(){
        ...
        myalert('修改产品','900px','660px',"<?php echo U('Product/edit');?>"+"?id="+id,confirm);
    })
...
<div id="content" class="wow fadeIn">
    <div id="content-header">
        ...
        <div class="mysearchbox fr">
            ...
            <form class="sform" action="<?php echo U('Product/list');?>" method="POST">
    ...
    <div class="container-fluid">
        <div class="someopt mt15">
            ...
            <?php if($perm['资源管理']['产品管理']['新增']): ?><button class="btn btn-primary fl add mr10"><i class="fa fa-plus"></i> 新增</button><?php endif; ?>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php if(is_array($productlist)): $k = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td><?php echo ($vo["price_unit"]); ?></td>
                        <td><?php echo ($vo["band_limit"]); ?></td>
                        <td><?php echo ($vo["desc"]); ?></td>
                        <td style="width: 200px;">
                            <?php if($perm['资源管理']['产品管理']['查看']): ?><button class="btn btn-sm btn-info view"><i class="fa fa-eye"></i></button><?php endif; ?>
                            <?php if($perm['资源管理']['产品管理']['修改']): ?><button class="btn btn-sm btn-warning edit"><i class="fa fa-edit"></i></button><?php endif; ?>
                            <?php if($perm['资源管理']['产品管理']['删除']): ?><button class="btn btn-sm btn-danger remove"><i class="fa fa-trash"></i></button><?php endif; ?>
                        </td>
