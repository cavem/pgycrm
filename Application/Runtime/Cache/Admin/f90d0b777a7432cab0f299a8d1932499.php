        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item layui-show">
                <div class="form-line w50 fl">
                    ...
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="cname" readonly value="<?php echo ($name); ?>">
                    </div>
                </div>
                <div class="form-line w50 fl">
                    <span class="form-label">订单编号：</span>
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="id" readonly value="<?php echo ($orderno); ?>">
                    </div>
                </div>
                <div class="form-line w50 fl">
                    <span class="form-label">相关销售：</span>
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="salesman" readonly value="<?php echo ($salesman); ?>">
                    </div>
                </div>
                <div class="form-line w50 fl">
                    <span class="form-label">相关合同：</span>
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="contract">
                    </div>
                </div>
                <div class="form-line w50 fl">
                ...
                <div class="form-line w50 fl">
                    ...
                    <div class="form-content" style="width: 250px;">
                        是 <input type="radio" name="free" value="true"> 
                        否 <input type="radio" name="free" value="false" checked>
                    </div>
                </div>
                <div class="form-line w50 fl">
                ...
                <div class="form-line w50 fl">
                    ...
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="order_begin_at" value="<?php echo date('Y-m-d H:i:s'); ?>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});">
                    </div>
                </div>
                <div class="form-line w50 fl">
                    <span class="form-label">下次付款日期：</span>
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="order_end_at" value="<?php echo date('Y-m-d H:i:s'); ?>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});">
                    </div>
                </div>
            ...
            <div class="layui-tab-item">
                <div class="form-line w50 fl">
                    ...
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="propertyof" value="<?php echo ($name); ?>">
                    </div>
                </div>
                <div class="form-line w50 fl">
                ...
                <div class="form-line w50 fl">
                    <span class="form-label"><span class="need" style="color: red;">*</span> 产品种类：</span>
                    <div class="form-content" style="width: 250px;">
                ...
                <div class="form-line w50 fl">
                    ...
                    <div class="form-content" style="width: 250px;">
                        <input class="form-control" type="text" name="money" value="1">
                    </div>
                </div>
