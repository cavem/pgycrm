...
$(function(){
    $('.add').click(function(){
        ...
        myalert('新增交换机','900px','660px',"<?php echo U('Switches/new');?>",confirm);
    })
    $('.view').click(function(){
        ...
        myalert('查看','900px','660px',"<?php echo U('Switches/view');?>"+"?name="+name,confirm);
    })
    $('.edit').click(function(){
        var name=$(this).closest('tr').find('.name').text();
        ...
        myalert('修改交换机【'+name+'】','900px','660px',"<?php echo U('Switches/edit');?>"+"?id="+id,confirm);
    })
    ...
    $('.gopage').click(function(){
        var cpage=$('.cpage').val();
        window.location.href="<?php echo U('Switches/list');?>"+"?p="+cpage;
    })
})
</script>
<div id="content" class="wow fadeIn">
    <div id="content-header">
        ...
        <div class="mysearchbox fr">
            ...
            <form class="sform" action="<?php echo U('Switches/list');?>" method="POST">
    ...
    <div class="container-fluid">
        <div class="someopt mt15">
            ...
            <?php if($perm['资源管理']['交换机管理']['新增']): ?><button class="btn btn-primary fl add mr10"><i class="fa fa-plus"></i> 新增</button><?php endif; ?>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php if(is_array($switcheslist)): $k = 0; $__LIST__ = $switcheslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($vo["id"]); ?></td>
                        <td class="name"><?php echo ($vo["switch_id"]); ?></td>
                        <td><?php echo ($vo["port_num"]); ?></td>
                        <td><?php echo ($vo["room"]); ?></td>
                        <td><?php echo ($vo["cabinet"]); ?></td>
                        <td><?php echo ($vo["asset_id"]); ?></td>
                        <td><?php echo ($vo["ip_addr"]); ?></td>
                        <td style="width: 200px;">
                            <?php if($perm['资源管理']['交换机管理']['查看']): ?><button class="btn btn-sm btn-info view"><i class="fa fa-eye"></i></button><?php endif; ?>
                            <?php if($perm['资源管理']['交换机管理']['修改']): ?><button class="btn btn-sm btn-warning edit"><i class="fa fa-edit"></i></button><?php endif; ?>
                            <?php if($perm['资源管理']['交换机管理']['删除']): ?><button class="btn btn-sm btn-danger remove"><i class="fa fa-trash"></i></button><?php endif; ?>
                        </td>
