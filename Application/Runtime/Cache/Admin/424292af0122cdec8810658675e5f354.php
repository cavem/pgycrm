...
<div id="content" class="wow fadeIn">
    <div id="content-header">
        <span class="header-title"><i class="fa fa-window-restore"></i> 部门管理</span>
    ...
    <div class="container-fluid">
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                <th>编号</th><th>等级 </th><th>描述</th><th>操作</th>
                </tr>
            </thead>
            <tbody>
                <?php if(is_array($departlist)): $k = 0; $__LIST__ = $departlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
