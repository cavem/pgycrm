                ...
                <div class="layui-tab-item layui-show">
                    <form class="mform layui-form" action="">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block" style="margin-left: 90px">
                              <select name="priority" lay-verify="required">
                                <option value="正常" <?php echo ($tasks['priority']=='正常'?'selected':''); ?>>正常</option>
                                <option value="优先" <?php echo ($tasks['priority']=='优先'?'selected':''); ?>>优先</option>
                                <option value="紧急" <?php echo ($tasks['priority']=='紧急'?'selected':''); ?>>紧急</option>
                              </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block" style="margin-left: 90px">
                              <select name="recvdept" lay-verify="required" lay-filter="dep">
                                <option value="技术部" <?php echo ($tasks['recvdept']=='技术部'?'selected':''); ?>>技术部</option>
                                <option value="网络部" <?php echo ($tasks['recvdept']=='网络部'?'selected':''); ?>>网络部</option>
                              </select>
                            </div>
                        </div>
                      ...
                      <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" style="margin-left: 90px">
                          <input type="text" name="title" required lay-verify="title" placeholder="请输入标题" autocomplete="off" class="layui-input" value="<?php echo ($tasks['title']); ?>">
                        </div>
                      </div>
                      ...
                      <div class="layui-form-item" style="">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                               <input type="number" name="timelimit" lay-verify="required|phone" autocomplete="off" class="layui-input" value="<?php echo ($tasks['timelimit']); ?>">
                            </div>
