...
<div class="myalert-main">
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <form class="mform">
                <input type="hidden" name="paysureby" value="<?php echo ($_SESSION['loginuser']['realname']); ?>">
                <td class="claaa"><b>款到确认人</b></td>
                <td><b><?php echo ($_SESSION['loginuser']['realname']); ?></b></td>
                <td class="claaa"><b>款到确认时间</b></td>
                <input type="hidden" name="paysure_at" value="<?php echo date('Y-m-d H:i:s'); ?>">
