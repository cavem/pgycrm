...
$(function(){
    ...
    $('.add').click(function(){
        ...
        myalert('新建考核','900px','660px',"<?php echo U('Hastaffchk/new');?>",confirm);
    })
    //查看
    $('.view').click(function(){
...
<div id="content" class="wow fadeIn">
    <div id="content-header">
        ...
        <form class="sform" action="<?php echo U('Hastaffchk/list');?>" method="GET">
    ...
    <div class="container-fluid">
        <div class="someopt mt15">
            ...
            <?php if($perm['人事管理']['员工考核']['考核']): ?><a href="javascript:;" class="btn btn-primary fl add"><i class="fa fa-plus"></i> 新建考核</a><?php endif; ?>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <td style="width: 100px;">
                        <?php if($perm['人事管理']['员工考核']['查看']): ?><button class="btn btn-info btn-sm view"><i class="fa fa-eye"></i></button><?php endif; ?> 
                    </td>
